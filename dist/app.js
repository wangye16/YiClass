  ...
  (0,_tarojs_taro__WEBPACK_IMPORTED_MODULE_0__.useLaunch)(() => {
    ...
    _tarojs_taro__WEBPACK_IMPORTED_MODULE_0___default().checkSession({
      ...
      fail: function () {
        ...
        _tarojs_taro__WEBPACK_IMPORTED_MODULE_0___default().login(); //重新登录
      }
    });
  });
